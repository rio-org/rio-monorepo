export const RioLRTOperatorRegistryABI = [
    ...
    inputs: [
      {
        name: 'config',
        type: 'tuple',
        internalType: 'struct IRioLRTOperatorRegistry.OperatorConfig',
        components: [
          {
            name: 'operator',
            type: 'address',
  ...
  {
    type: 'function',
    name: 'completeOperatorStrategyExit',
    inputs: [
      {
        name: 'operatorId',
        type: 'uint8',
  ...
  {
    type: 'function',
    name: 'isValidStrategyExitRootForOperator',
    inputs: [
      {
        name: 'operatorId',
        type: 'uint8',
  ...
  {
    type: 'function',
    name: 'setProofUploader',
    inputs: [
      {
        name: 'newProofUploader',
        type: 'address',
        internalType: 'address',
      },
    ],
  ...
  {
    type: 'event',
    name: 'OperatorStrategyExitCompleted',
    inputs: [
      {
        name: 'operatorId',
        type: 'uint8',
  ...
  {
    type: 'event',
    name: 'StrategySharesDeallocated',
    inputs: [
      {
        name: 'operatorId',
        type: 'uint8',
  ...
  {
    type: 'error',
    name: 'INVALID_EARNINGS_RECEIVER',
    inputs: [],
  },
  {
    type: 'error',
    name: 'INVALID_HEAP_SIZE',
    inputs: [],
  },
  {
    type: 'error',
  ...
  {
    type: 'error',
    name: 'INVALID_OPERATOR_DELEGATOR',
    inputs: [],
  },
  {
    type: 'error',
    name: 'INVALID_PENDING_MANAGER',
    inputs: [],
  },
  {
    type: 'error',
    name: 'INVALID_STRATEGY_EXIT_ROOT',
    inputs: [],
  },
  {
    type: 'error',
    name: 'INVALID_STRATEGY_LENGTH_FOR_EXIT',
    inputs: [],
  },
  {
    type: 'error',
    name: 'INVALID_VALIDATOR_COUNT',
    inputs: [],
  },
  {
    type: 'error',
  ...
  {
    type: 'error',
    name: 'MAX_OPERATOR_COUNT_EXCEEDED',
    inputs: [],
  },
  {
    type: 'error',
  ...
  {
    type: 'error',
    name: 'ONLY_COORDINATOR',
    inputs: [],
  },
  {
    type: 'error',
    name: 'ONLY_DEPOSIT_POOL',
    inputs: [],
  },
  {
    type: 'error',
  ...
  {
    type: 'error',
    name: 'ONLY_OPERATOR_MANAGER',
    inputs: [],
  },
  {
    type: 'error',
    name: 'ONLY_OPERATOR_MANAGER_OR_PROOF_UPLOADER',
    inputs: [],
  },
  {
    type: 'error',
  ...
  {
    type: 'error',
    name: 'ONLY_OPERATOR_PENDING_MANAGER',
    inputs: [],
  },
  {
    type: 'error',
    name: 'ONLY_OPERATOR_REGISTRY',
    inputs: [],
  },
  {
    type: 'error',
    name: 'OPERATOR_ALREADY_ACTIVE',
    inputs: [],
  },
  {
    type: 'error',
    name: 'OPERATOR_ALREADY_INACTIVE',
    inputs: [],
  },
  {
    type: 'error',
