...
abstract contract RioDeployer is EigenLayerDeployer {
    ...
    function deployRio() public {
        ...
        address tokenWrapperFactory = address(new TokenWrapperFactory(address(this)));
        address issuerImpl = address(0); // TODO
        // address issuerImpl = address(
        //     new RioLRTIssuer(
        //         MANAGED_POOL_FACTORY_ADDRESS,
        //         WETH_ADDRESS,
        //         address(new RioLRT()),
        //         address(new RioLRTCoordinator(tokenWrapperFactory, WETH_ADDRESS, VAULT_ADDRESS, BALANCER_QUERIES_ADDRESS)),
        //         address(0), // address(new RioLRTAssetManager(tokenWrapperFactory, VAULT_ADDRESS, WETH_ADDRESS)),
